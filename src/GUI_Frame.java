...
public class GUI_Frame extends JFrame {
		...
		protected void initWindow() 
		{
			...
			mouse.setBounds(5, 400, 200, 25);
			human.setBounds(305, 400, 200,25);
			GC_content_text.setBounds(5,425, 590, 25);
			thr_min.setBounds(5,450, 200, 25);
			Threshold_min.setBounds(315, 450, 200, 25);
			thr_max.setBounds(5,475, 200, 25);
			Threshold_max.setBounds(315, 475, 200, 25);
		...
		GetRibozymesFromSeq con = new GetRibozymesFromSeq(sequenceInput1, refTranscriptome, thresholdFieldMax, thresholdFieldMin);
